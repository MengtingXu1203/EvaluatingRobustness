...
# Architecture
parser.add_argument('--model-name', '-m', default='InceptionV3', type=str,
...
parser.add_argument('--perturbation', '-p', default='rotate', type=str,
...
# #    model_file = "/home/lrh/store/modelpath/adversarial_defense/Messidor/adversarial_training_standard.pth"
...
#     modelFile = "/home/lrh/store/modelpath/adversarial_defense/Dermothsis/adv_training_MAAdvT.pth"
...
CKPT_PATH = '/home/lrh/store/modelpath/adversarial_defense/ChestXay/adversarial_training_MPAdvT.pth'
N_CLASSES = 14
cudnn.benchmark = True
...
#         print(data.shape)
# #        print(num_vids)
#         data = data.view(-1,3,299,299).cuda()
# #        print(data.shape)
#         if args.model_name == 'AttnVGG':
#             output,_,_ = net(data)
#         else:
